 ...
 */
final class Version20220208100027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE restaurant_zipcode (restaurant_id INT NOT NULL, zipcode_id INT NOT NULL, INDEX IDX_9F475DB7B1E7706E (restaurant_id), INDEX IDX_9F475DB7E4C7FA21 (zipcode_id), PRIMARY KEY(restaurant_id, zipcode_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE restaurant ADD relation_secteur_id INT DEFAULT NULL, ADD relation_user_id INT DEFAULT NULL, ADD relation_type_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restaurant DROP relation_secteur_id, DROP relation_user_id, DROP relation_type_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE phone phone VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE adress adress VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE city city VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`');
