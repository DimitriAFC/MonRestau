 ...
 */
final class Version20220209095320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE zip_code ADD city VARCHAR(100) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE zip_code DROP city, CHANGE number number VARCHAR(5) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
