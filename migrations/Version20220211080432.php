 ...
 */
final class Version20220211080432 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vehicle CHANGE type type VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE number_plate number_plate VARCHAR(9) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE livreur livreur VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
